...
- Sommige facturen hebben GEEN aparte eenheidskolom (alleen "Aantal"). Gebruik dan deze vuistregel: een DECIMAAL aantal (bv. "3,6" of "37,3") kan vrijwel nooit stuks zijn — dat is bijna altijd een gewicht in kilogram. Een HEEL getal (bv. "30" of "80") duidt meestal op stuks, tenzij de artikelnaam of context iets anders aangeeft (bv. expliciet "kg" in de naam). Vul in dat geval zelf "unit" in op basis van deze vuistregel, ook al staat er geen aparte eenheidskolom.
